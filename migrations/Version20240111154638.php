 ...
 */
final class Version20240111154638 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE marche (id INT AUTO_INCREMENT NOT NULL, proprietaire_id INT NOT NULL, categorie_id INT DEFAULT NULL, adresse VARCHAR(255) NOT NULL, date_debut DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', date_fin DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', nom VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, note DOUBLE PRECISION NOT NULL, INDEX IDX_BAA18ACC76C50E4A (proprietaire_id), INDEX IDX_BAA18ACCBCF5E72D (categorie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE marche ADD CONSTRAINT FK_BAA18ACC76C50E4A FOREIGN KEY (proprietaire_id) REFERENCES producteur (id)');
